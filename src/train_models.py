...
def train_models(clean_file_path="../data/processed/cleaned_data.csv",model_dir="../models"):
    ...
    features = ["x_norm", "y_norm", "team_encoded", "move_dist", "dist_to_goal", "possession_streak", "prev_event_enc", "rolling_entropy"]
    ...
    rf_param_dist = {
        ...
        "clf__max_features": ["sqrt", "tog2", 0.5]
    }

    rf_search = RandomizedSearchCV(rf_pipe, rf_param_dist, n_iter=10, cv=3,scoring="f1_weighted",random_state=42)
    ...
    joblib.dump(model_dir, "xgboost.joblib")
